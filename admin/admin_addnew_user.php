		...
		<div id="content">
			...
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td class="border border_bs col_2"><input type="text" name="txtRegion" /></td>
				...
				<tr>
					...
					<td colspan="2" class="border border_bs border_rs border_rs"><select name="selUserType"><option></option><option>Administrator</option><option>Regional officer</option></select>
				</tr>
			</table>
