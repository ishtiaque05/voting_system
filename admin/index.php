<?php
	...
	if($submit == "Log in"){
		...
		if(mysql_num_rows($sqlSelUser) == 1){
			...
			$sqlSelUserInfo = mysql_query("select user_type, fname, mname, lname from tblusers where voter_id = '$userid'") or die(mysql_error());
			...
			if($userType == "Administrator")
				...
				header("location: regionalofficer_page.php");
			else
